 ...
 */
export function authLoginAccessToken(serviceURL: string, accessTokenUrlOrPath: string): void {
 ...
 */
export function deinitializeCallClient(callClient: CallClient): void {
    try {
